...
func init():
	...
	#Otherwise, load level (useful for testing)
		...
		load_level("Level1", "Level1")
	
func load_level(path:String ,name:String):
	...
	#temp
	if(name == "MainMenu"):
		lvl_path_full = "res://Scenes/Menus/MainMenu.tscn"
	elif(name == "Level1"):
		lvl_path_full = "res://Scenes/Levels/Level1.tscn"
	elif(name == "Test"):
